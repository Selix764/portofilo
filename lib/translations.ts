...
export const translations = {
  ro: {
    ...
    howItStarted: {
      ...
      storyDescription1: 'Călătoria mea în programare a început din curiozitate pură — aveam în jur de 7 sau 8 ani când am început să mă întreb cum funcționează de fapt calculatoarele. Am încercat să învăț, dar ca majoritatea copiilor, am pierdut răbdarea destul de repede.',
      storyDescription2: 'Ani mai târziu, când aveam 13 ani, ceva s-a declanșat. Am văzut un prieten al unui prieten — doar un adolescent — care și-a construit propriul motor de joc de la zero. Era autodidact, organizat și concentrat. M-a inspirat. Dacă el putea să facă asta, și eu puteam.',
      storyDescription3: 'M-am aruncat în acest domeniu, am început să învăț tot ce puteam — de la frontend la API-uri până la construirea de aplicații reale. Nu mult după aceea, am obținut primul meu proiect ajutând o mică echipă rusă cu o aplicație desktop WPF. Nu era perfect, dar era real.',
      keyPointsTitle: 'Puncte Cheie',
      keyPoint1: 'Început din curiozitate la 7-8 ani',
      keyPoint2: 'Inspirat de un adolescent la 13 ani',
      keyPoint3: 'Primul proiect real la 15 ani',
  ...
  en: {
    ...
    howItStarted: {
      ...
      storyTitle: 'My Story',
      storyDescription1: 'My journey into programming started from pure curiosity — I was around 7 or 8 when I first wondered how computers actually worked. I tried to learn, but like most kids, I lost patience pretty quickly.',
      storyDescription2: 'Years later, when I was 13, something clicked. I saw a friend of a friend — just a teenager — who had built his own game engine from scratch. He was self-taught, organized, and focused. It inspired me. If he could do it, so could I.',
      storyDescription3: 'I dove in, started learning everything I could — from frontend to APIs to building real apps. Not long after, I landed my first project helping a small Russian team with a WPF desktop app. It wasn\'t perfect, but it was real.',
      keyPointsTitle: 'Key Points',
      keyPoint1: 'Started from pure curiosity at 7-8 years old',
      keyPoint2: 'Inspired by a teenager at 13 years old',
      keyPoint3: 'First real project at 15 years old',
